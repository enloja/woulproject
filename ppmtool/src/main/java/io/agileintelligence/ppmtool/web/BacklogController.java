...
public class BacklogController {
    ...
    public Iterable<ProjectTask> getProjectsBacklog(@PathVariable String backlog_id, Principal principal) {
    ...
    public ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id, Principal principal){
        ...
        return new ResponseEntity<>("Project with ID '"+pt_id+"' was delete", HttpStatus.OK);
